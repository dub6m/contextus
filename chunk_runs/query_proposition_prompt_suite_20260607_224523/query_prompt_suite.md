...
- Created at: `2026-06-07T22:49:59`
- LLM client: `None`
- Embedding cache: `chunk_runs\embedding_cache\all-MiniLM-L6-v2_query_package_texts.pkl`
- Embedding cache stats: `{'calls': 294, 'requested_texts': 6132, 'hits': 6121, 'misses': 11, 'missing_text_examples': ['[Cluster | 10df1306-44f3-4f91-8197-3837b77b863f]\nLet ω = min{d(q→ 0, q→ 1), d(r→ 0 , r→ 1 )}.\n\n[Cluster | ce0cf796-65d5-475d-9d5c-3da8b9280c50]\nThe algorithm needs to answer the question: Is there a pair of points q →Q, ', "[Cluster | 67a39aaf-a349-440a-b757-73df2e21cf06]\nFormula: Let n = |P'| = |P' subscript x | = |P' subscript y |\n\n[Core | a9df6684-476c-4e05-9357-c26cca191fb6]\nUsing a single pass through each of P → x and P → y in time O(", '[Cluster | 5c881cc7-ae53-4404-a88a-e159a9d7287d]\nFigure (figure): A vertical DNA double helix diagram with purple strands and light-colored rectangular labels containing nucleotide letters (A, T, G, C) along the backbone', '[Cluster | 894a8eea-a1e9-4349-816d-02573e81d308]\nThe distance between any two points can be computed in O(1) time.\n\n[Cluster | 10450c4d-d590-4e6d-819c-2dbc33105eb9]\nMembership in a set or list can be computed in O(1) tim', '[Core | 5228c5dd-9a61-4a29-9f78-60da6331a90d]\nSuppose q→ 0 and q→ 1 are returned as a closest pair of points in Q and r→ 0 and r→ 1 are returned as a closest pair of points in R.\n\n[Cluster | 10df1306-44f3-4f91-8197-3837b', '[Core | 5228c5dd-9a61-4a29-9f78-60da6331a90d]\nSuppose q→ 0 and q→ 1 are returned as a closest pair of points in Q and r→ 0 and r→ 1 are returned as a closest pair of points in R.\n\n[Cluster | 10df1306-44f3-4f91-8197-3837b', '[Cluster | 24e04180-52d9-4df6-9bb1-2e90a26087c3]\n4 The list Ry, consisting of the points in R sorted by increasing y-coordinate.\n\n[Cluster | c5a1897f-6691-4ce0-8bc5-939d3a2d9918]\nThe reason these 4 lists are created is s', '[Completion | 10df1306-44f3-4f91-8197-3837b77b863f]\nLet ω = min{d(q→ 0, q→ 1), d(r→ 0 , r→ 1 )}.\n\n[Core | f5a0c62d-21db-4a8c-9eea-0b5e52736b98]\nLet S ↑P →be those points that are within distance ω from L.\n\n[Completion | ', '[Cluster | 6f7e05fe-f98d-431a-920a-3e537a4c5059]\nFigure (figure): A large bordered rectangle contains a 2x2 grid of light grey cells. Each cell is labeled with a two-letter genotype: top-left CC, top-right CD, bottom-lef', '[Cluster | 6f7e05fe-f98d-431a-920a-3e537a4c5059]\nFigure (figure): A large bordered rectangle contains a 2x2 grid of light grey cells. Each cell is labeled with a two-letter genotype: top-left CC, top-right CD, bottom-lef']}`
...
- `need:frame:83ad266b-1f91-41c5-8e1e-33c9f8090936::p00:document:00:slots.related_1` slots.related_1: algorithm will solve (filled_but_unsupported)
- `need:frame:83ad266b-1f91-41c5-8e1e-33c9f8090936::p00:document:00:slots.related_2` slots.related_2: closest pair problem (filled_but_unsupported)

Trace preview:

- `need_created` `frame:83ad266b-1f91-41c5-8e1e-33c9f8090936::p00:document:00`: slots.related_1 is filled_but_unsupported
- `candidate_rejected` ``: no matching support frame
...
- Core frames: `frame:bd983412-a9a1-4053-8782-9c0f2953bcbd::p00:document:00`
- Selected frames: ``
- Selected elements: ``
- Resolved needs: `0`
- Unresolved needs: `2`
...
- `need:frame:bd983412-a9a1-4053-8782-9c0f2953bcbd::p00:document:00:slots.related_1` slots.related_1: above three pairs (filled_but_unsupported)
- `need:frame:bd983412-a9a1-4053-8782-9c0f2953bcbd::p00:document:00:slots.related_2` slots.related_2: above three (filled_but_unsupported)
...
- Core frames: `frame:41838264-4ad6-4d12-9a1e-a7b2b7ec6098::p00:document:00`
...
- Selected elements: `10450c4d-d590-4e6d-819c-2dbc33105eb9, 4de228da-f792-47d3-b580-9a0fcbfcbc21, 5bbb0471-218e-4844-9b2a-6ba045ab257e, 8dd3811f-29b7-4f89-bb08-ef9530afa532, a46ab66d-5834-4ffe-a088-a167c7ea101a`
- Resolved needs: `6`
- Unresolved needs: `4`

Unresolved:

- `need:frame:4de228da-f792-47d3-b580-9a0fcbfcbc21::p00:document:00:slots.related_2` slots.related_2: other point (filled_but_unsupported)
- `need:frame:8dd3811f-29b7-4f89-bb08-ef9530afa532::p00:document:00:slots.related_2` slots.related_2: nd (filled_but_unsupported)
- `need:frame:a46ab66d-5834-4ffe-a088-a167c7ea101a::p00:document:00:slots.related_2` slots.related_2: boxes separating points (filled_but_unsupported)
- `need:frame:5bbb0471-218e-4844-9b2a-6ba045ab257e::p00:document:00:slots.related_1` slots.related_1: right half (filled_but_unsupported)
...
- `need_resolved` `frame:8dd3811f-29b7-4f89-bb08-ef9530afa532::p00:document:00`: candidate frame targets the missing term and adds information
- `need_created` `frame:4de228da-f792-47d3-b580-9a0fcbfcbc21::p00:document:00`: slots.related_1 is filled_but_unsupported
- `need_resolved` `frame:a46ab66d-5834-4ffe-a088-a167c7ea101a::p00:document:00`: candidate frame targets the missing term and adds information
...
- Core frames: `frame:4b3c6a26-4ac6-4f75-8dcf-9c01c773e109::p00:document:00`
- Selected frames: `frame:4de228da-f792-47d3-b580-9a0fcbfcbc21::p00:document:00, frame:10df1306-44f3-4f91-8197-3837b77b863f::p00:document:00, frame:41838264-4ad6-4d12-9a1e-a7b2b7ec6098::p00:document:00, frame:ce0cf796-65d5-475d-9d5c-3da8b9280c50::p00:document:00, frame:bce2aeaa-0e73-49b1-a254-8f44b1a51f1a::p03:document:00, frame:8dd3811f-29b7-4f89-bb08-ef9530afa532::p00:document:00, frame:f72b8b5f-7078-4e8b-ade1-7ae2158ec759::p00:document:00, frame:bce2aeaa-0e73-49b1-a254-8f44b1a51f1a::p01:document:00`
- Selected elements: `10df1306-44f3-4f91-8197-3837b77b863f, 41838264-4ad6-4d12-9a1e-a7b2b7ec6098, 4de228da-f792-47d3-b580-9a0fcbfcbc21, 8dd3811f-29b7-4f89-bb08-ef9530afa532, bce2aeaa-0e73-49b1-a254-8f44b1a51f1a, ce0cf796-65d5-475d-9d5c-3da8b9280c50, f72b8b5f-7078-4e8b-ade1-7ae2158ec759`
- Resolved needs: `11`
- Unresolved needs: `1`
...
- `need_created` `frame:4de228da-f792-47d3-b580-9a0fcbfcbc21::p00:document:00`: slots.related_1 is filled_but_unsupported
- `need_resolved` `frame:41838264-4ad6-4d12-9a1e-a7b2b7ec6098::p00:document:00`: candidate frame targets the missing term and adds information
- `need_created` `frame:4de228da-f792-47d3-b580-9a0fcbfcbc21::p00:document:00`: slots.related_2 is filled_but_unsupported
- `candidate_rejected` ``: no matching support frame

#### Dependency Package 5

- Core frames: `frame:08ca4c99-09ae-4b81-b1fc-86befa8ecca7::p00:document:00`
- Selected frames: `frame:e4e4cc5b-c753-47fb-9d8e-513c6b55ed9a::p00:document:00, frame:8dd3811f-29b7-4f89-bb08-ef9530afa532::p00:document:00, frame:0ee6964b-75e7-47f9-b8a9-8bc4a96b5fbc::p00:document:00, frame:41838264-4ad6-4d12-9a1e-a7b2b7ec6098::p00:document:00, frame:50b28678-2a11-470f-8b59-1ea5258a929e::p00:document:00`
- Selected elements: `0ee6964b-75e7-47f9-b8a9-8bc4a96b5fbc, 41838264-4ad6-4d12-9a1e-a7b2b7ec6098, 50b28678-2a11-470f-8b59-1ea5258a929e, 8dd3811f-29b7-4f89-bb08-ef9530afa532, e4e4cc5b-c753-47fb-9d8e-513c6b55ed9a`
- Resolved needs: `6`
- Unresolved needs: `2`

Unresolved:

- `need:frame:08ca4c99-09ae-4b81-b1fc-86befa8ecca7::p00:document:00:slots.related_2` slots.related_2: closest (filled_but_unsupported)
- `need:frame:8dd3811f-29b7-4f89-bb08-ef9530afa532::p00:document:00:slots.related_2` slots.related_2: nd (filled_but_unsupported)

Trace preview:

- `need_created` `frame:08ca4c99-09ae-4b81-b1fc-86befa8ecca7::p00:document:00`: slots.related_1 is filled_but_unsupported
- `need_resolved` `frame:e4e4cc5b-c753-47fb-9d8e-513c6b55ed9a::p00:document:00`: candidate frame targets the missing term and adds information
- `need_created` `frame:08ca4c99-09ae-4b81-b1fc-86befa8ecca7::p00:document:00`: slots.related_2 is filled_but_unsupported
- `candidate_rejected` ``: no matching support frame
- `need_created` `frame:e4e4cc5b-c753-47fb-9d8e-513c6b55ed9a::p00:document:00`: slots.related_1 is filled_but_unsupported
- `need_resolved` `frame:8dd3811f-29b7-4f89-bb08-ef9530afa532::p00:document:00`: candidate frame targets the missing term and adds information
- `need_created` `frame:e4e4cc5b-c753-47fb-9d8e-513c6b55ed9a::p00:document:00`: slots.related_2 is filled_but_unsupported
- `need_resolved` `frame:0ee6964b-75e7-47f9-b8a9-8bc4a96b5fbc::p00:document:00`: candidate frame targets the missing term and adds information
...
- Core frames: `frame:5561f627-73d3-4d5d-a52a-7f774ecce384::p00:document:00`
- Selected frames: `frame:e5904b42-69b0-4dd5-ad6d-09154207473f::p01:document:00`
- Selected elements: `e5904b42-69b0-4dd5-ad6d-09154207473f`
- Resolved needs: `2`
- Unresolved needs: `2`

Unresolved:

- `need:frame:5561f627-73d3-4d5d-a52a-7f774ecce384::p00:document:00:slots.related_2` slots.related_2: technique used (filled_but_unsupported)
- `need:frame:e5904b42-69b0-4dd5-ad6d-09154207473f::p01:document:00:slots.related_2` slots.related_2: now (filled_but_unsupported)

Trace preview:

- `need_created` `frame:5561f627-73d3-4d5d-a52a-7f774ecce384::p00:document:00`: slots.related_1 is filled_but_unsupported
- `need_resolved` `frame:e5904b42-69b0-4dd5-ad6d-09154207473f::p01:document:00`: candidate frame targets the missing term and adds information
- `need_created` `frame:5561f627-73d3-4d5d-a52a-7f774ecce384::p00:document:00`: slots.related_2 is filled_but_unsupported
- `candidate_rejected` ``: no matching support frame
- `need_created` `frame:e5904b42-69b0-4dd5-ad6d-09154207473f::p01:document:00`: slots.related_1 is filled_but_unsupported
...
- `need_created` `frame:e5904b42-69b0-4dd5-ad6d-09154207473f::p01:document:00`: slots.related_2 is filled_but_unsupported
- `candidate_rejected` ``: no matching support frame

#### Dependency Package 3

- Core frames: `frame:0b7d3bb2-23a5-4a96-a4ef-bd4ba403e36f::p00:document:00`
- Selected frames: ``
- Selected elements: ``
- Resolved needs: `0`
- Unresolved needs: `2`
...
- `need:frame:0b7d3bb2-23a5-4a96-a4ef-bd4ba403e36f::p00:document:00:slots.related_1` slots.related_1: now state (filled_but_unsupported)
- `need:frame:0b7d3bb2-23a5-4a96-a4ef-bd4ba403e36f::p00:document:00:slots.related_2` slots.related_2: complete algorithm (filled_but_unsupported)
...
- Core frames: `frame:1666ea78-de13-4272-baa8-f733a68ca358::p00:document:00`
- Selected frames: ``
- Selected elements: ``
- Resolved needs: `0`
- Unresolved needs: `2`
...
- `need:frame:1666ea78-de13-4272-baa8-f733a68ca358::p00:document:00:slots.related_1` slots.related_1: us consider (filled_but_unsupported)
- `need:frame:1666ea78-de13-4272-baa8-f733a68ca358::p00:document:00:slots.related_2` slots.related_2: pair algorithm (filled_but_unsupported)
...
- Core frames: `frame:4de228da-f792-47d3-b580-9a0fcbfcbc21::p00:document:00`
- Selected frames: `frame:41838264-4ad6-4d12-9a1e-a7b2b7ec6098::p00:document:00, frame:a46ab66d-5834-4ffe-a088-a167c7ea101a::p00:document:00, frame:8dd3811f-29b7-4f89-bb08-ef9530afa532::p00:document:00`
- Selected elements: `41838264-4ad6-4d12-9a1e-a7b2b7ec6098, 8dd3811f-29b7-4f89-bb08-ef9530afa532, a46ab66d-5834-4ffe-a088-a167c7ea101a`
- Resolved needs: `5`
- Unresolved needs: `3`
...
- Core frames: `frame:1d5da4bf-6baa-4d51-8a5a-4b48f3fc42a5::p00:document:00`
- Selected frames: `frame:c5a1897f-6691-4ce0-8bc5-939d3a2d9918::p00:document:00, frame:8dd3811f-29b7-4f89-bb08-ef9530afa532::p00:document:00, frame:41838264-4ad6-4d12-9a1e-a7b2b7ec6098::p00:document:00`
- Selected elements: `41838264-4ad6-4d12-9a1e-a7b2b7ec6098, 8dd3811f-29b7-4f89-bb08-ef9530afa532, c5a1897f-6691-4ce0-8bc5-939d3a2d9918`
- Resolved needs: `3`
- Unresolved needs: `3`

Unresolved:

- `need:frame:1d5da4bf-6baa-4d51-8a5a-4b48f3fc42a5::p00:document:00:slots.related_1` slots.related_1: recursively call recursive (filled_but_unsupported)
- `need:frame:c5a1897f-6691-4ce0-8bc5-939d3a2d9918::p00:document:00:slots.related_1` slots.related_1: call itself (filled_but_unsupported)
- `need:frame:8dd3811f-29b7-4f89-bb08-ef9530afa532::p00:document:00:slots.related_2` slots.related_2: nd (filled_but_unsupported)

Trace preview:

- `need_created` `frame:1d5da4bf-6baa-4d51-8a5a-4b48f3fc42a5::p00:document:00`: slots.related_1 is filled_but_unsupported
- `candidate_rejected` `frame:bbe5d3e7-1cd2-4852-869a-8afa4fd64368::p00:document:00`: frame:bbe5d3e7-1cd2-4852-869a-8afa4fd64368::p00:document:00: same target without added information
- `candidate_rejected` `frame:bbe5d3e7-1cd2-4852-869a-8afa4fd64368::p00:document:00`: no candidate with the same target added usable information
- `need_created` `frame:1d5da4bf-6baa-4d51-8a5a-4b48f3fc42a5::p00:document:00`: slots.related_2 is filled_but_unsupported
- `need_resolved` `frame:c5a1897f-6691-4ce0-8bc5-939d3a2d9918::p00:document:00`: candidate frame targets the missing term and adds information
...
- Core frames: `frame:c5a1897f-6691-4ce0-8bc5-939d3a2d9918::p00:document:00`
- Selected frames: `frame:8dd3811f-29b7-4f89-bb08-ef9530afa532::p00:document:00, frame:41838264-4ad6-4d12-9a1e-a7b2b7ec6098::p00:document:00, frame:4de228da-f792-47d3-b580-9a0fcbfcbc21::p00:document:00`
- Selected elements: `41838264-4ad6-4d12-9a1e-a7b2b7ec6098, 4de228da-f792-47d3-b580-9a0fcbfcbc21, 8dd3811f-29b7-4f89-bb08-ef9530afa532`
- Resolved needs: `4`
- Unresolved needs: `2`
...
- `need_created` `frame:c5a1897f-6691-4ce0-8bc5-939d3a2d9918::p00:document:00`: slots.related_2 is filled_but_unsupported
- `need_resolved` `frame:8dd3811f-29b7-4f89-bb08-ef9530afa532::p00:document:00`: candidate frame targets the missing term and adds information
- `need_created` `frame:8dd3811f-29b7-4f89-bb08-ef9530afa532::p00:document:00`: slots.related_1 is filled_but_unsupported
- `need_resolved` `frame:41838264-4ad6-4d12-9a1e-a7b2b7ec6098::p00:document:00`: candidate frame targets the missing term and adds information
- `need_created` `frame:8dd3811f-29b7-4f89-bb08-ef9530afa532::p00:document:00`: slots.related_2 is filled_but_unsupported
- `candidate_rejected` ``: no matching support frame
...
- Core frames: `frame:5731e158-77c8-40c1-99ab-9f7d7153cd8f::p00:document:00`
- Selected frames: `frame:1ba0e92c-e6fe-41ed-ab08-72ce9a40429d::p00:document:00, frame:97fffa61-7318-4597-a00a-77e404954848::p00:document:00, frame:894a8eea-a1e9-4349-816d-02573e81d308::p00:document:00, frame:713a1b86-d19e-4e6e-bb75-dae56d46dd8f::p00:document:00, frame:05efea84-58f1-4497-8495-9fd89f52846c::p00:document:00, frame:13ca234b-6c24-46d6-b6b9-e09bd9797194::p00:document:00, frame:d10c0930-e19e-42ad-9e48-dc827b70397f::p00:document:00`
- Selected elements: `05efea84-58f1-4497-8495-9fd89f52846c, 13ca234b-6c24-46d6-b6b9-e09bd9797194, 1ba0e92c-e6fe-41ed-ab08-72ce9a40429d, 713a1b86-d19e-4e6e-bb75-dae56d46dd8f, 894a8eea-a1e9-4349-816d-02573e81d308, 97fffa61-7318-4597-a00a-77e404954848, d10c0930-e19e-42ad-9e48-dc827b70397f`
- Resolved needs: `11`
- Unresolved needs: `1`

Unresolved:

- `need:frame:894a8eea-a1e9-4349-816d-02573e81d308::p00:document:00:slots.related_1` slots.related_1: any two points (filled_but_unsupported)

Trace preview:

- `need_created` `frame:5731e158-77c8-40c1-99ab-9f7d7153cd8f::p00:document:00`: slots.related_1 is filled_but_unsupported
- `need_resolved` `frame:1ba0e92c-e6fe-41ed-ab08-72ce9a40429d::p00:document:00`: candidate frame targets the missing term and adds information
- `need_created` `frame:5731e158-77c8-40c1-99ab-9f7d7153cd8f::p00:document:00`: slots.related_2 is filled_but_unsupported
- `need_resolved` `frame:97fffa61-7318-4597-a00a-77e404954848::p00:document:00`: candidate frame targets the missing term and adds information
- `need_created` `frame:1ba0e92c-e6fe-41ed-ab08-72ce9a40429d::p00:document:00`: slots.related_1 is filled_but_unsupported
- `need_resolved` `frame:894a8eea-a1e9-4349-816d-02573e81d308::p00:document:00`: candidate frame targets the missing term and adds information
- `need_created` `frame:1ba0e92c-e6fe-41ed-ab08-72ce9a40429d::p00:document:00`: slots.related_2 is filled_but_unsupported
- `need_resolved` `frame:713a1b86-d19e-4e6e-bb75-dae56d46dd8f::p00:document:00`: candidate frame targets the missing term and adds information

#### Dependency Package 2

- Core frames: `frame:97ce0acc-6a33-4948-8a0e-b25c0ce53b8e::p00:document:00`
- Selected frames: ``
- Selected elements: ``
- Resolved needs: `0`
- Unresolved needs: `2`
...
- `need:frame:97ce0acc-6a33-4948-8a0e-b25c0ce53b8e::p00:document:00:slots.related_1` slots.related_1: some reasonable assumptions (filled_but_unsupported)
- `need:frame:97ce0acc-6a33-4948-8a0e-b25c0ce53b8e::p00:document:00:slots.related_2` slots.related_2: reasonable assumptions regarding (filled_but_unsupported)
...
- Core frames: `frame:1993ceff-a5f5-4336-8298-9e163879b12b::p00:document:00`
- Selected frames: ``
- Selected elements: ``
- Resolved needs: `0`
- Unresolved needs: `2`
...
- `need:frame:1993ceff-a5f5-4336-8298-9e163879b12b::p00:document:00:slots.related_1` slots.related_1: same (filled_but_unsupported)
- `need:frame:1993ceff-a5f5-4336-8298-9e163879b12b::p00:document:00:slots.related_2` slots.related_2: contents (filled_but_unsupported)
...
- Core frames: `frame:76b0a53b-2b4c-4324-a2fb-d38d07ba0f74::p00:document:00`
- Selected frames: ``
- Selected elements: ``
- Resolved needs: `0`
- Unresolved needs: `2`
...
- `need:frame:76b0a53b-2b4c-4324-a2fb-d38d07ba0f74::p00:document:00:slots.related_1` slots.related_1: qx (filled_but_unsupported)
- `need:frame:76b0a53b-2b4c-4324-a2fb-d38d07ba0f74::p00:document:00:slots.related_2` slots.related_2: rx (filled_but_unsupported)
...
- Core frames: `frame:10450c4d-d590-4e6d-819c-2dbc33105eb9::p01:document:00`
- Selected frames: ``
- Selected elements: ``
- Resolved needs: `0`
- Unresolved needs: `2`
...
- `need:frame:10450c4d-d590-4e6d-819c-2dbc33105eb9::p01:document:00:slots.related_1` slots.related_1: will make use (filled_but_unsupported)
- `need:frame:10450c4d-d590-4e6d-819c-2dbc33105eb9::p01:document:00:slots.related_2` slots.related_2: two assumptions when (filled_but_unsupported)
...
#### Part 1: constructed, constructed o, contents

- Role: `main`
- Center: `center-0`
- Trace anchor: `f5a0c62d-21db-4a8c-9eea-0b5e52736b98`
- Topic terms: ``
- Claim units: `constructed, constructed o, contents, contents p, coordinate, coordinate note, coordinate note sy, denote, denote list, denote list s, dista, distance`
- Evidence elements: `f5a0c62d-21db-4a8c-9eea-0b5e52736b98, 18800611-e0e8-427a-a98c-430326deb838, 1993ceff-a5f5-4336-8298-9e163879b12b`
- Package: `query-source-traversal-package-00000`
- Core: `f5a0c62d-21db-4a8c-9eea-0b5e52736b98`
- Score: `0.4858`
...
- Core frames: `frame:a4c211f4-8627-4138-8b44-97108796c166::p01:document:00`
- Selected frames: `frame:90bb1f2f-0d0b-44c5-b1c6-7004cb951a29::p00:document:00, frame:6f7e05fe-f98d-431a-920a-3e537a4c5059::p02:document:00, frame:90bb1f2f-0d0b-44c5-b1c6-7004cb951a29::p03:document:00, frame:6f7e05fe-f98d-431a-920a-3e537a4c5059::p04:document:00, frame:3674a9c5-b9b5-4e8d-9e8f-625e528cbe6c::p02:document:00, frame:c64b48cf-9cef-4d50-a50c-c5cafa3d241c::p03:document:00`
- Selected elements: `3674a9c5-b9b5-4e8d-9e8f-625e528cbe6c, 6f7e05fe-f98d-431a-920a-3e537a4c5059, 90bb1f2f-0d0b-44c5-b1c6-7004cb951a29, c64b48cf-9cef-4d50-a50c-c5cafa3d241c`
- Resolved needs: `7`
- Unresolved needs: `1`

Unresolved:

- `need:frame:a4c211f4-8627-4138-8b44-97108796c166::p01:document:00:slots.related_2` slots.related_2: too simple (filled_but_unsupported)
...
- `need_resolved` `frame:6f7e05fe-f98d-431a-920a-3e537a4c5059::p02:document:00`: candidate frame targets the missing term and adds information
...
- Core frames: `frame:90bb1f2f-0d0b-44c5-b1c6-7004cb951a29::p00:document:00`
...
- `need:frame:6f7e05fe-f98d-431a-920a-3e537a4c5059::p04:document:00:slots.related_2` slots.related_2: gametes c d (filled_but_unsupported)
- `need:frame:3674a9c5-b9b5-4e8d-9e8f-625e528cbe6c::p02:document:00:slots.related_1` slots.related_1: labels ab (filled_but_unsupported)
- `need:frame:3674a9c5-b9b5-4e8d-9e8f-625e528cbe6c::p02:document:00:slots.related_2` slots.related_2: grid shows row (filled_but_unsupported)
- `need:frame:c64b48cf-9cef-4d50-a50c-c5cafa3d241c::p03:document:00:slots.related_2` slots.related_2: b c c (filled_but_unsupported)
...
- `need_created` `frame:90bb1f2f-0d0b-44c5-b1c6-7004cb951a29::p00:document:00`: slots.related_2 is filled_but_unsupported
- `need_resolved` `frame:90bb1f2f-0d0b-44c5-b1c6-7004cb951a29::p03:document:00`: candidate frame targets the missing term and adds information
- `need_created` `frame:6f7e05fe-f98d-431a-920a-3e537a4c5059::p02:document:00`: slots.related_1 is filled_but_unsupported
- `need_resolved` `frame:6f7e05fe-f98d-431a-920a-3e537a4c5059::p04:document:00`: candidate frame targets the missing term and adds information
- `need_created` `frame:6f7e05fe-f98d-431a-920a-3e537a4c5059::p02:document:00`: slots.related_2 is filled_but_unsupported
...
- Core frames: `frame:3674a9c5-b9b5-4e8d-9e8f-625e528cbe6c::p00:document:00`
- Selected frames: `frame:3674a9c5-b9b5-4e8d-9e8f-625e528cbe6c::p03:document:00, frame:3674a9c5-b9b5-4e8d-9e8f-625e528cbe6c::p05:document:00, frame:3674a9c5-b9b5-4e8d-9e8f-625e528cbe6c::p04:document:00`
- Selected elements: `3674a9c5-b9b5-4e8d-9e8f-625e528cbe6c`
- Resolved needs: `6`
- Unresolved needs: `0`
...
- `need_resolved` `frame:3674a9c5-b9b5-4e8d-9e8f-625e528cbe6c::p03:document:00`: candidate frame targets the missing term and adds information
- `need_created` `frame:3674a9c5-b9b5-4e8d-9e8f-625e528cbe6c::p00:document:00`: slots.related_2 is filled_but_unsupported
- `need_resolved` `frame:3674a9c5-b9b5-4e8d-9e8f-625e528cbe6c::p03:document:00`: candidate frame targets the missing term and adds information
- `need_created` `frame:3674a9c5-b9b5-4e8d-9e8f-625e528cbe6c::p03:document:00`: slots.related_1 is filled_but_unsupported
- `need_resolved` `frame:3674a9c5-b9b5-4e8d-9e8f-625e528cbe6c::p00:document:00`: candidate frame targets the missing term and adds information
- `need_created` `frame:3674a9c5-b9b5-4e8d-9e8f-625e528cbe6c::p03:document:00`: slots.related_2 is filled_but_unsupported
- `need_resolved` `frame:3674a9c5-b9b5-4e8d-9e8f-625e528cbe6c::p05:document:00`: candidate frame targets the missing term and adds information
...
- Core frames: `frame:5697b313-5a56-4477-889a-73f51726e46c::p00:document:00`
- Selected frames: `frame:5fb18c72-8d2a-414e-b89e-bffdc43debee::p00:document:00, frame:5697b313-5a56-4477-889a-73f51726e46c::p01:document:00`
- Selected elements: `5697b313-5a56-4477-889a-73f51726e46c, 5fb18c72-8d2a-414e-b89e-bffdc43debee`
- Resolved needs: `3`
- Unresolved needs: `3`

Unresolved:

- `need:frame:5697b313-5a56-4477-889a-73f51726e46c::p00:document:00:slots.related_2` slots.related_2: p generation (filled_but_unsupported)
- `need:frame:5fb18c72-8d2a-414e-b89e-bffdc43debee::p00:document:00:slots.related_2` slots.related_2: y (filled_but_unsupported)
- `need:frame:5697b313-5a56-4477-889a-73f51726e46c::p01:document:00:slots.related_2` slots.related_2: p generation (filled_but_unsupported)
...
- `candidate_rejected` `frame:5697b313-5a56-4477-889a-73f51726e46c::p01:document:00`: frame:5697b313-5a56-4477-889a-73f51726e46c::p01:document:00: same target without added information
- `candidate_rejected` `frame:5697b313-5a56-4477-889a-73f51726e46c::p01:document:00`: no candidate with the same target added usable information
- `need_created` `frame:5fb18c72-8d2a-414e-b89e-bffdc43debee::p00:document:00`: slots.related_1 is filled_but_unsupported
...
- `need_created` `frame:5fb18c72-8d2a-414e-b89e-bffdc43debee::p00:document:00`: slots.related_2 is filled_but_unsupported
...
[Cluster | 11291337-ce01-4485-b0c3-2b3b3f82bd48] Figure (figure): A cross-sectional labeled diagram of a cell with organelles including chromosome material, nucleus, cytoplasm, ribosomes, mitochondrion, and nuclear membrane; outer boundary representing the cell membrane; labels and lines point to each structure.. Chromosome material Nucleus Cytoplasm Ribosomes Mitochondrion Nuclear membrane [Core | ba059811-2313-4133-be94-3708bc4e9222] Figure (figure): A pale green schematic illustration of a cell cross-section with labels pointing to chromosome material, nucleus, cytoplasm, ribosomes, mitochondrion, and nuclear membrane.. Chromosome material Nucleus Cytoplasm Ribosomes Mitochondrion Nuclear membrane The Ribosome [Cluster | e5b25bd1-c98a-4cd9-a5ef-6007be1d2a1e] Figure (figure): A black-and-white schematic cellular diagram depicting mRNA as a courier on the left border and tRNA-associated amino acids on the right, with purple starburst markers along the path of translating tRNAs, a ribosome at the bottom translating the mRNA across the cell border labeled CELL. The diagram is bordered and includes stepwise annotations (1–6) describing transcription and translation steps, arrows indi
...
- Core frames: `frame:cf7fefc9-528a-4ab6-93cc-d486fb83addd::p00:document:00`
- Selected frames: `frame:cf7fefc9-528a-4ab6-93cc-d486fb83addd::p01:document:00, frame:cf7fefc9-528a-4ab6-93cc-d486fb83addd::p02:document:00`
- Selected elements: `cf7fefc9-528a-4ab6-93cc-d486fb83addd`
- Resolved needs: `3`
- Unresolved needs: `3`

Unresolved:

- `need:frame:cf7fefc9-528a-4ab6-93cc-d486fb83addd::p00:document:00:slots.related_1` slots.related_1: four haploid cells (filled_but_unsupported)
- `need:frame:cf7fefc9-528a-4ab6-93cc-d486fb83addd::p01:document:00:slots.related_1` slots.related_1: f (filled_but_unsupported)
- `need:frame:cf7fefc9-528a-4ab6-93cc-d486fb83addd::p02:document:00:slots.related_1` slots.related_1: four haploid cells (filled_but_unsupported)

Trace preview:

- `need_created` `frame:cf7fefc9-528a-4ab6-93cc-d486fb83addd::p00:document:00`: slots.related_1 is filled_but_unsupported
- `candidate_rejected` `frame:cf7fefc9-528a-4ab6-93cc-d486fb83addd::p02:document:00`: frame:cf7fefc9-528a-4ab6-93cc-d486fb83addd::p02:document:00: same target without added information
- `candidate_rejected` `frame:cf7fefc9-528a-4ab6-93cc-d486fb83addd::p02:document:00`: no candidate with the same target added usable information
- `need_created` `frame:cf7fefc9-528a-4ab6-93cc-d486fb83addd::p00:document:00`: slots.related_2 is filled_but_unsupported
- `need_resolved` `frame:cf7fefc9-528a-4ab6-93cc-d486fb83addd::p01:document:00`: candidate frame targets the missing term and adds information
...
- Core frames: `frame:ba059811-2313-4133-be94-3708bc4e9222::p00:document:00`
- Selected frames: `frame:11291337-ce01-4485-b0c3-2b3b3f82bd48::p00:document:00, frame:67455ddd-c064-4b40-8e9a-25d71b4a9a24::p02:document:00, frame:67455ddd-c064-4b40-8e9a-25d71b4a9a24::p01:document:00`
- Selected elements: `11291337-ce01-4485-b0c3-2b3b3f82bd48, 67455ddd-c064-4b40-8e9a-25d71b4a9a24`
- Resolved needs: `6`
- Unresolved needs: `0`
...
- Core frames: `frame:67455ddd-c064-4b40-8e9a-25d71b4a9a24::p00:document:00`
- Selected frames: ``
- Selected elements: ``
- Resolved needs: `0`
- Unresolved needs: `2`
...
- `need:frame:67455ddd-c064-4b40-8e9a-25d71b4a9a24::p00:document:00:slots.related_1` slots.related_1: illustration showing (filled_but_unsupported)
- `need:frame:67455ddd-c064-4b40-8e9a-25d71b4a9a24::p00:document:00:slots.related_2` slots.related_2: mitosis around (filled_but_unsupported)
...
- Core frames: `frame:c64b48cf-9cef-4d50-a50c-c5cafa3d241c::p00:document:00`
- Selected frames: `frame:c64b48cf-9cef-4d50-a50c-c5cafa3d241c::p01:document:00, frame:6f7e05fe-f98d-431a-920a-3e537a4c5059::p01:document:00`
- Selected elements: `6f7e05fe-f98d-431a-920a-3e537a4c5059, c64b48cf-9cef-4d50-a50c-c5cafa3d241c`
- Resolved needs: `3`
- Unresolved needs: `3`

Unresolved:

- `need:frame:c64b48cf-9cef-4d50-a50c-c5cafa3d241c::p00:document:00:slots.related_1` slots.related_1: side schematic figures (filled_but_unsupported)
- `need:frame:c64b48cf-9cef-4d50-a50c-c5cafa3d241c::p01:document:00:slots.related_2` slots.related_2: labeled along (filled_but_unsupported)
- `need:frame:6f7e05fe-f98d-431a-920a-3e537a4c5059::p01:document:00:slots.related_1` slots.related_1: s (filled_but_unsupported)
...
- `need_created` `frame:c64b48cf-9cef-4d50-a50c-c5cafa3d241c::p01:document:00`: slots.related_1 is filled_but_unsupported
...
- `need_created` `frame:c64b48cf-9cef-4d50-a50c-c5cafa3d241c::p01:document:00`: slots.related_2 is filled_but_unsupported
- `candidate_rejected` ``: no matching support frame
...
- Core frames: `frame:2c51abd0-a1e0-4e0b-b332-13265cb9de9c::p00:document:00`
- Selected frames: ``
- Selected elements: ``
- Resolved needs: `0`
- Unresolved needs: `2`
...
- `need:frame:2c51abd0-a1e0-4e0b-b332-13265cb9de9c::p00:document:00:slots.related_1` slots.related_1: ribbons labeled (filled_but_unsupported)
- `need:frame:2c51abd0-a1e0-4e0b-b332-13265cb9de9c::p00:document:00:slots.related_2` slots.related_2: vertical blue frames (filled_but_unsupported)
...
- Core frames: `frame:9366ae0a-a7a7-4119-ad7c-891e0f4bd8f2::p00:document:00`
- Selected frames: `frame:9366ae0a-a7a7-4119-ad7c-891e0f4bd8f2::p01:document:00`
- Selected elements: `9366ae0a-a7a7-4119-ad7c-891e0f4bd8f2`
- Resolved needs: `2`
- Unresolved needs: `2`

Unresolved:

- `need:frame:9366ae0a-a7a7-4119-ad7c-891e0f4bd8f2::p00:document:00:slots.related_1` slots.related_1: parent strands conserved (filled_but_unsupported)
- `need:frame:9366ae0a-a7a7-4119-ad7c-891e0f4bd8f2::p01:document:00:slots.related_2` slots.related_2: c t g (filled_but_unsupported)
...
- `need_resolved` `frame:9366ae0a-a7a7-4119-ad7c-891e0f4bd8f2::p01:document:00`: candidate frame targets the missing term and adds information
- `need_created` `frame:9366ae0a-a7a7-4119-ad7c-891e0f4bd8f2::p01:document:00`: slots.related_1 is filled_but_unsupported
- `need_resolved` `frame:9366ae0a-a7a7-4119-ad7c-891e0f4bd8f2::p00:document:00`: candidate frame targets the missing term and adds information
- `need_created` `frame:9366ae0a-a7a7-4119-ad7c-891e0f4bd8f2::p01:document:00`: slots.related_2 is filled_but_unsupported
- `candidate_rejected` ``: no matching support frame

#### Dependency Package 3

- Core frames: `frame:903420c9-37c4-40a7-8935-a76b94781541::p01:document:00`
- Selected frames: `frame:5c881cc7-ae53-4404-a88a-e159a9d7287d::p00:document:00, frame:5c881cc7-ae53-4404-a88a-e159a9d7287d::p06:document:00, frame:5c881cc7-ae53-4404-a88a-e159a9d7287d::p01:document:00`
- Selected elements: `5c881cc7-ae53-4404-a88a-e159a9d7287d`
- Resolved needs: `5`
- Unresolved needs: `1`

Unresolved:

- `need:frame:903420c9-37c4-40a7-8935-a76b94781541::p01:document:00:slots.related_2` slots.related_2: dna double (filled_but_unsupported)
...
- `need_resolved` `frame:903420c9-37c4-40a7-8935-a76b94781541::p01:document:00`: candidate frame targets the missing term and adds information
- `need_created` `frame:5c881cc7-ae53-4404-a88a-e159a9d7287d::p00:document:00`: slots.related_2 is filled_but_unsupported
- `need_resolved` `frame:5c881cc7-ae53-4404-a88a-e159a9d7287d::p06:document:00`: candidate frame targets the missing term and adds information

#### Dependency Package 4

- Core frames: `frame:5c881cc7-ae53-4404-a88a-e159a9d7287d::p00:document:00`
- Selected frames: `frame:903420c9-37c4-40a7-8935-a76b94781541::p01:document:00, frame:5c881cc7-ae53-4404-a88a-e159a9d7287d::p06:document:00, frame:5c881cc7-ae53-4404-a88a-e159a9d7287d::p01:document:00, frame:5c881cc7-ae53-4404-a88a-e159a9d7287d::p03:document:00`
- Selected elements: `5c881cc7-ae53-4404-a88a-e159a9d7287d, 903420c9-37c4-40a7-8935-a76b94781541`
- Resolved needs: `7`
- Unresolved needs: `1`
...
- Core frames: `frame:e5b25bd1-c98a-4cd9-a5ef-6007be1d2a1e::p00:document:00`
- Selected frames: `frame:e5b25bd1-c98a-4cd9-a5ef-6007be1d2a1e::p07:document:00`
- Selected elements: `e5b25bd1-c98a-4cd9-a5ef-6007be1d2a1e`
- Resolved needs: `2`
- Unresolved needs: `2`

Unresolved:

- `need:frame:e5b25bd1-c98a-4cd9-a5ef-6007be1d2a1e::p00:document:00:slots.related_2` slots.related_2: schematic cellular diagram (filled_but_unsupported)
- `need:frame:e5b25bd1-c98a-4cd9-a5ef-6007be1d2a1e::p07:document:00:slots.related_2` slots.related_2: amino (filled_but_unsupported)

Trace preview:

- `need_created` `frame:e5b25bd1-c98a-4cd9-a5ef-6007be1d2a1e::p00:document:00`: slots.related_1 is filled_but_unsupported
- `need_resolved` `frame:e5b25bd1-c98a-4cd9-a5ef-6007be1d2a1e::p07:document:00`: candidate frame targets the missing term and adds information
- `need_created` `frame:e5b25bd1-c98a-4cd9-a5ef-6007be1d2a1e::p00:document:00`: slots.related_2 is filled_but_unsupported
- `candidate_rejected` ``: no matching support frame
- `need_created` `frame:e5b25bd1-c98a-4cd9-a5ef-6007be1d2a1e::p07:document:00`: slots.related_1 is filled_but_unsupported
...
- `need_created` `frame:e5b25bd1-c98a-4cd9-a5ef-6007be1d2a1e::p07:document:00`: slots.related_2 is filled_but_unsupported
- `candidate_rejected` ``: no matching support frame
...
- Core frames: `frame:83e0e7dc-9bb0-41c0-affa-0943d092955d::p01:document:00`
- Selected frames: `frame:83e0e7dc-9bb0-41c0-affa-0943d092955d::p03:document:00`
- Selected elements: `83e0e7dc-9bb0-41c0-affa-0943d092955d`
- Resolved needs: `2`
- Unresolved needs: `2`

Unresolved:

- `need:frame:83e0e7dc-9bb0-41c0-affa-0943d092955d::p01:document:00:slots.related_2` slots.related_2: sickle cell (filled_but_unsupported)
- `need:frame:83e0e7dc-9bb0-41c0-affa-0943d092955d::p03:document:00:slots.related_2` slots.related_2: cell anaemia (filled_but_unsupported)

Trace preview:

- `need_created` `frame:83e0e7dc-9bb0-41c0-affa-0943d092955d::p01:document:00`: slots.related_1 is filled_but_unsupported
- `need_resolved` `frame:83e0e7dc-9bb0-41c0-affa-0943d092955d::p03:document:00`: candidate frame targets the missing term and adds information
- `need_created` `frame:83e0e7dc-9bb0-41c0-affa-0943d092955d::p01:document:00`: slots.related_2 is filled_but_unsupported
- `candidate_rejected` ``: no matching support frame
- `need_created` `frame:83e0e7dc-9bb0-41c0-affa-0943d092955d::p03:document:00`: slots.related_1 is filled_but_unsupported
- `need_resolved` `frame:83e0e7dc-9bb0-41c0-affa-0943d092955d::p01:document:00`: candidate frame targets the missing term and adds information
- `need_created` `frame:83e0e7dc-9bb0-41c0-affa-0943d092955d::p03:document:00`: slots.related_2 is filled_but_unsupported
- `candidate_rejected` ``: no matching support frame

#### Dependency Package 2

- Core frames: `frame:cf7fefc9-528a-4ab6-93cc-d486fb83addd::p01:document:00`
- Selected frames: `frame:cf7fefc9-528a-4ab6-93cc-d486fb83addd::p00:document:00`
- Selected elements: `cf7fefc9-528a-4ab6-93cc-d486fb83addd`
- Resolved needs: `2`
- Unresolved needs: `2`
...
- Core frames: `frame:11291337-ce01-4485-b0c3-2b3b3f82bd48::p00:document:00`
- Selected frames: `frame:ba059811-2313-4133-be94-3708bc4e9222::p00:document:00, frame:67455ddd-c064-4b40-8e9a-25d71b4a9a24::p02:document:00, frame:67455ddd-c064-4b40-8e9a-25d71b4a9a24::p01:document:00`
- Selected elements: `67455ddd-c064-4b40-8e9a-25d71b4a9a24, ba059811-2313-4133-be94-3708bc4e9222`
- Resolved needs: `7`
- Unresolved needs: `1`

Unresolved:

- `need:frame:67455ddd-c064-4b40-8e9a-25d71b4a9a24::p01:document:00:slots.related_1` slots.related_1: late telophase (filled_but_unsupported)
...
- Core frames: `frame:cf7fefc9-528a-4ab6-93cc-d486fb83addd::p02:document:00`
- Selected frames: `frame:cf7fefc9-528a-4ab6-93cc-d486fb83addd::p01:document:00, frame:cf7fefc9-528a-4ab6-93cc-d486fb83addd::p00:document:00`
- Selected elements: `cf7fefc9-528a-4ab6-93cc-d486fb83addd`
- Resolved needs: `3`
- Unresolved needs: `3`
...
- `candidate_rejected` `frame:cf7fefc9-528a-4ab6-93cc-d486fb83addd::p00:document:00`: frame:cf7fefc9-528a-4ab6-93cc-d486fb83addd::p00:document:00: same target without added information
- `candidate_rejected` `frame:cf7fefc9-528a-4ab6-93cc-d486fb83addd::p00:document:00`: no candidate with the same target added usable information
...
- Core frames: `frame:ff3ff6e5-4fd5-49eb-b243-ad9ae374e956::p01:document:00`
- Selected frames: `frame:ff3ff6e5-4fd5-49eb-b243-ad9ae374e956::p00:document:00`
- Selected elements: `ff3ff6e5-4fd5-49eb-b243-ad9ae374e956`
- Resolved needs: `4`
- Unresolved needs: `0`
...
- `need_resolved` `frame:ff3ff6e5-4fd5-49eb-b243-ad9ae374e956::p00:document:00`: candidate frame targets the missing term and adds information
- `need_created` `frame:ff3ff6e5-4fd5-49eb-b243-ad9ae374e956::p00:document:00`: slots.related_1 is filled_but_unsupported
- `need_resolved` `frame:ff3ff6e5-4fd5-49eb-b243-ad9ae374e956::p01:document:00`: candidate frame targets the missing term and adds information
- `need_created` `frame:ff3ff6e5-4fd5-49eb-b243-ad9ae374e956::p00:document:00`: slots.related_2 is filled_but_unsupported
- `need_resolved` `frame:ff3ff6e5-4fd5-49eb-b243-ad9ae374e956::p01:document:00`: candidate frame targets the missing term and adds information

#### Dependency Package 2

- Core frames: `frame:8c0aa646-66d3-412c-9233-61cdf9551399::p02:document:00`
- Selected frames: ``
- Selected elements: ``
- Resolved needs: `0`
- Unresolved needs: `2`
...
- `need:frame:8c0aa646-66d3-412c-9233-61cdf9551399::p02:document:00:slots.related_1` slots.related_1: green (filled_but_unsupported)
- `need:frame:8c0aa646-66d3-412c-9233-61cdf9551399::p02:document:00:slots.related_2` slots.related_2: triangle (filled_but_unsupported)
...
- Core frames: `frame:cf237c37-1e0c-4ef1-ace2-9021261af4b3::p00:document:00`
- Selected frames: ``
- Selected elements: ``
- Resolved needs: `0`
- Unresolved needs: `2`
...
- `need:frame:cf237c37-1e0c-4ef1-ace2-9021261af4b3::p00:document:00:slots.related_1` slots.related_1: biological diversity (filled_but_unsupported)
- `need:frame:cf237c37-1e0c-4ef1-ace2-9021261af4b3::p00:document:00:slots.related_2` slots.related_2: environmental conditions (filled_but_unsupported)
...
- Core frames: `frame:4a280e02-b110-4ca9-ba8a-b66565d17566::p00:document:00`
- Selected frames: ``
- Selected elements: ``
- Resolved needs: `0`
- Unresolved needs: `2`
...
- `need:frame:4a280e02-b110-4ca9-ba8a-b66565d17566::p00:document:00:slots.related_1` slots.related_1: culture (filled_but_unsupported)
- `need:frame:4a280e02-b110-4ca9-ba8a-b66565d17566::p00:document:00:slots.related_2` slots.related_2: one (filled_but_unsupported)
...
- Core frames: `frame:c09a9c9d-1109-49c6-a1ec-be997279709f::p00:document:00`
- Selected frames: `frame:c09a9c9d-1109-49c6-a1ec-be997279709f::p01:document:00, frame:6f7e05fe-f98d-431a-920a-3e537a4c5059::p02:document:00, frame:6f7e05fe-f98d-431a-920a-3e537a4c5059::p04:document:00, frame:3674a9c5-b9b5-4e8d-9e8f-625e528cbe6c::p02:document:00, frame:c64b48cf-9cef-4d50-a50c-c5cafa3d241c::p03:document:00`
- Selected elements: `3674a9c5-b9b5-4e8d-9e8f-625e528cbe6c, 6f7e05fe-f98d-431a-920a-3e537a4c5059, c09a9c9d-1109-49c6-a1ec-be997279709f, c64b48cf-9cef-4d50-a50c-c5cafa3d241c`
- Resolved needs: `6`
- Unresolved needs: `4`

Unresolved:

- `need:frame:c09a9c9d-1109-49c6-a1ec-be997279709f::p01:document:00:slots.related_2` slots.related_2: isolated island (filled_but_unsupported)
- `need:frame:6f7e05fe-f98d-431a-920a-3e537a4c5059::p04:document:00:slots.related_2` slots.related_2: gametes c d (filled_but_unsupported)
- `need:frame:3674a9c5-b9b5-4e8d-9e8f-625e528cbe6c::p02:document:00:slots.related_1` slots.related_1: labels ab (filled_but_unsupported)
- `need:frame:3674a9c5-b9b5-4e8d-9e8f-625e528cbe6c::p02:document:00:slots.related_2` slots.related_2: grid shows row (filled_but_unsupported)
...
- `need_resolved` `frame:c09a9c9d-1109-49c6-a1ec-be997279709f::p01:document:00`: candidate frame targets the missing term and adds information
- `need_created` `frame:c09a9c9d-1109-49c6-a1ec-be997279709f::p00:document:00`: slots.related_2 is filled_but_unsupported
- `need_resolved` `frame:6f7e05fe-f98d-431a-920a-3e537a4c5059::p02:document:00`: candidate frame targets the missing term and adds information
- `need_created` `frame:c09a9c9d-1109-49c6-a1ec-be997279709f::p01:document:00`: slots.related_1 is filled_but_unsupported
- `need_resolved` `frame:c09a9c9d-1109-49c6-a1ec-be997279709f::p00:document:00`: candidate frame targets the missing term and adds information
- `need_created` `frame:c09a9c9d-1109-49c6-a1ec-be997279709f::p01:document:00`: slots.related_2 is filled_but_unsupported
- `candidate_rejected` ``: no matching support frame
